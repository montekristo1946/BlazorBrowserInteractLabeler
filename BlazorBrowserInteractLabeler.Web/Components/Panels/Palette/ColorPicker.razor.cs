...
namespace BlazorBrowserInteractLabeler.Web.Components.Panels.Palette;
...
public class ColorPickerModel : ComponentBase
{
    ...
    [Parameter]
    public string MyColor { get; set; } = null!;

    [Parameter]
    public bool IsOpened { get; set; }

    [Parameter]
    public string[] MyColorPallet { get; set; } = null!;

    [Parameter]
    public string OverwriteBackgroundColor { get; set; } = null!;

    [Parameter]
    public EventCallback<string> Closed { get; set; }

    internal string customStyle => !string.IsNullOrWhiteSpace(OverwriteBackgroundColor) ? $"background-color:{OverwriteBackgroundColor}" : "";
    ...
    internal void ColorClick(string color)
    {
        MyColor = color;
        StateHasChanged();
        Closed.InvokeAsync(MyColor);
